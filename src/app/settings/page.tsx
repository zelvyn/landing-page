...
export default function SettingsPage() {
  const { user, preferences, updatePreferences, theme, setTheme } = useUserStore();
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-neutral-600">Receive promotional content</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-neutral-50 rounded-lg">
                      <h3 className="font-medium text-neutral-900 mb-2">Profile Visibility</h3>
                    ...
                    <div className="p-4 bg-neutral-50 rounded-lg">
                      <h3 className="font-medium text-neutral-900 mb-2">Show Online Status</h3>
                      <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg bg-white cursor-pointer transition-all ${
                            theme === "light" ? "border-primary-500 ring-2 ring-primary-200" : "border-neutral-300 hover:border-neutral-400"
                          }`}
                        >
                        ...
                        <button
                          ...
                          className={`p-4 border-2 rounded-lg bg-neutral-800 cursor-pointer transition-all ${
                            theme === "dark" ? "border-primary-500 ring-2 ring-primary-200" : "border-neutral-300 hover:border-neutral-400"
                          }`}
                        >
